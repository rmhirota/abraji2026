---
title: "Bootcamp R<br>Congresso Abraji 2026"
subtitle: "Do primeiro passo à primeira pauta"
# author: "[**Ana Carolina Moreno**](https://www.linkedin.com/in/anacarolinamoreno)<br>[**Jade Reis**](https://www.linkedin.com/in/jademare/)<br><u>[Link dessa apresentação](https://bit.ly/abraji_2025)</u>"
author: "[Link dessa apresentação: https://bit.ly/abraji2026](https://bit.ly/abraji2026)"
format: revealjs
incremental: false
...
**Jade Reis:** Consultora na Maré Consultoria. Co-organiza a R-Ladies São Paulo.

**Geovana L.Batista**: Cientista de dados no Banco BMG e co-organizadora R-Ladies São Paulo.

**Cecília do Lago:** Jornalista freelancer.

**Renata Hirota:** Jornalista de dados no InfoAmazonia.

## Cronograma previsto

**Parte 1 (9h30-11h): Introdução**  
R + RStudio + ciência de dados

**Parte 2 (11h30-13h): Conceitos de programação**  
Escrevendo os primeiros códigos

**Parte 3 (11h30-13h): Tidyverse**  
Conjunto de pacotes para análise de dados 

**Parte 4 (11h30-13h): Exercícios**  
...
-   Entrar [nesse Github](https://github.com/rmhirota/abraji2026/)–\> clicar no botão verde chamado "Code" –\> escolher "Download zip" –\> descomprimir a pasta e salvar no local que quiser na pasta onde você for trabalhar
...
```{r}
alesp <- read_csv2("data/alesp.csv", locale = locale(encoding = "Windows-1252"))
...
-   [Repositório de arquivos](https://github.com/rmhirota/abraji_2026) dessa oficina

-   Essa apostila: [https://hirota.dev/abraji2026/abraji_2026](https://hirota.dev/abraji2026/abraji_2026)

-   [Grupo no WhatsApp dessa oficina: https://bit.ly/bootcamp-r-abraji-2026](https://bit.ly/bootcamp-r-abraji-2026) (link disponível até 03/08/2026)

-   [Oficina de pacotes com Rafael Pereira](https://ipeagit.github.io/censobr_oficina_abraji_2025)

-   Link para o [script com todo o código do Rafael Pereira](https://github.com/rmhirota/abraji_2026/blob/main/oficina_censobr_geobr.R)

-   Documento de [links e referências](https://github.com/rmhirota/abraji2026/blob/main/links_e_referencias.pdf) de leitura, cursos e comunidades
